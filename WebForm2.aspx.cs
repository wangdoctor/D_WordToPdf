...
namespace WebApplication2
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        {
            string s = ConvertDateTimeToInt(DateTime.Now).ToString();
            try
            {
                ...
                {
                    WordConvertPDF(filePath, Server.MapPath("~\\html\\"+s+".pdf"), MSWord.WdExportFormat.wdExportFormatPDF);
                }
                //转换 
                // wordToHtml(File1);
            }
            ...
            {
                Response.Write("失败："+ex.ToString());
            }
            finally
            {
                Response.Write("恭喜，转换成功！下载地址："+"http://word.stones.red/html/"+s+".pdf");
            }
